    ...
    translation: {
        ...
        export_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    "Une erreur s'est produite. Besoin d'aide ? sqllab@yandex.ru",
            },
        },
        import_diagram_dialog: {
            ...
            error: {
                title: "Erreur lors de l'exportation du diagramme",
                description:
                    "Le diagramme JSON n'est pas valide. Veuillez vérifier le JSON et réessayer. Besoin d'aide ? sqllab@yandex.ru",
            },
        },
        import_dbml_dialog: {
