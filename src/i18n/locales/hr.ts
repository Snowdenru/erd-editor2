    ...
    translation: {
        ...
        export_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'Nešto je pošlo po zlu. Trebate pomoć? sqllab@yandex.ru',
            },
        },
        ...
        import_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'JSON dijagrama je nevažeći. Molimo provjerite JSON i pokušajte ponovno. Trebate pomoć? sqllab@yandex.ru',
            },
        },
